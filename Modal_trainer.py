...
detect = cv2.face.LBPHFaceRecognizer_create() # Local Binary Patterns Histograms        cv2.face.LBPHFaceRecognizer_create()
...
detect.train(faces, np.array(ids))

detect.write('Trainer/trainer.yml')  # Save the trained model as trainer.yml
